...
<body>
	<center>
		...
		<table>
               <tr>
				<td colspan="1"></td>
				<td class="text2" style="text-align: right;">{{ $dataDosen->updated_at->format('d M Y') }}</td>
			</tr>
			<tr class="text2">
				<td>Nomer</td>
				<td width="572">: -</td>
		...
		<table width="625">
			<tr>
		       <td>
			       <font size="2">Kpd yth.<br>Bapak/Ibu {{$dataDosen->nama_dosen }}<br>Di tempat</font>
		       </td>
		    </tr>
		</table>
		<br>
		<table width="625">
			<tr>
		       <td>
			       <font size="2"> <p class="isi-mail">Dengan ini memberitahukan kepada dosen dengan nama <strong class="nama_dosen">{{ $dataDosen->nama_dosen}}</strong> pada tanggal {{ $dataDosen->updated_at->format('d M Y')}} berakhir tugas sebagai dosen
                         pada Universitas Islam riau(UIR) Yayasan Lembaga Pendidikan Islam Riau.
                         Untuk itu kami sebagai pihak universitas perlu menyampaikan kepada bapak/ibu untuk menyelesaikan Administrasi untuk kelancaran
                         validasi data.   </p></font>
		       </td>
