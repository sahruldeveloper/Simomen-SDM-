...
<body>
	<center>
		...
		<table width="625">
			<tr>
		       <td>
			       <font size="2">Kpd yth.<br>Bapak/Ibu {{$data->nama }}<br>Di tempat</font>
		       </td>
		    </tr>
		</table>
		<br>
		<table width="625">
			<tr>
		       <td>
			       <font size="2"> <p class="isi-mail">Dengan ini memberitahukan kepada karyawan dengan nama <strong>{{ $data->nama}}</strong> pada {{ $data->updated_at->format('d M Y')}} telah naik pangkat menjadi <strong>{{ $nama_pangkat }}</strong> dengan golongan <strong>{{ $nama_golongan }}</strong> 
          
                         Untuk itu kami sebagai pihak yayasan perlu menyampaikan kepada bapak/ibu untuk menyelesaikan Administrasi untuk kelancaran
                         validasi data. 
                    </p> </font>
		       </td>
